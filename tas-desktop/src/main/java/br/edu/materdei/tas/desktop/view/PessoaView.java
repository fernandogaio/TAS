...
import br.edu.materdei.tas.desktop.dialog.ClienteDialog;
import br.edu.materdei.tas.desktop.dialog.FornecedorDialog;
...
public class PessoaView extends GenericView {
    private Object[] dados;
    private View showView;
    
    private enum View {CLIENTE, FORNECEDOR};
    ...
    public PessoaView() {
        ...
        btCliente.setIcon(new ImageIcon(getClass().getResource("/assets/toolbar/cliente.png")));
        btFornecedor.setIcon(new ImageIcon(getClass().getResource("/assets/toolbar/fornecedor.png")));        
    ...
    private void initComponents() {
        ...
        acaoCliFor = new javax.swing.JPanel();
        tbCliFor = new javax.swing.JPanel();
        btCliente = new br.edu.materdei.tas.desktop.gui.core.TasItemToolBar();
        tasSeparadorItem2 = new br.edu.materdei.tas.desktop.gui.core.TasSeparadorItem();
        btFornecedor = new br.edu.materdei.tas.desktop.gui.core.TasItemToolBar();
        divRight1 = new javax.swing.JPanel();
        labelCliFor = new javax.swing.JLabel();
        ...
        acaoCliFor.setMinimumSize(new java.awt.Dimension(155, 99));
        acaoCliFor.setOpaque(false);
        acaoCliFor.setPreferredSize(new java.awt.Dimension(118, 99));
        acaoCliFor.setLayout(new java.awt.BorderLayout());

        tbCliFor.setMaximumSize(new java.awt.Dimension(32767, 78));
        tbCliFor.setMinimumSize(new java.awt.Dimension(57, 78));
        tbCliFor.setOpaque(false);
        tbCliFor.setPreferredSize(new java.awt.Dimension(124, 78));
        tbCliFor.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEADING, 0, 0));

        btCliente.setToolTipText("Cadastro de Cliente");
        btCliente.setLabel("Clientes");
        btCliente.setMaximumSize(new java.awt.Dimension(52, 78));
        btCliente.setMinimumSize(new java.awt.Dimension(52, 78));
        btCliente.setPreferredSize(new java.awt.Dimension(52, 78));
        btCliente.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btClienteMousePressed(evt);
            }
        });
        tbCliFor.add(btCliente);
        ...
        tbCliFor.add(tasSeparadorItem2);

        btFornecedor.setToolTipText("Cadastro de Fornecedor");
        btFornecedor.setDoubleBuffered(false);
        btFornecedor.setLabel("Fornecs.");
        btFornecedor.setMaximumSize(new java.awt.Dimension(52, 78));
        btFornecedor.setMinimumSize(new java.awt.Dimension(52, 78));
        btFornecedor.setPreferredSize(new java.awt.Dimension(52, 78));
        btFornecedor.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                btFornecedorMousePressed(evt);
            }
        });
        tbCliFor.add(btFornecedor);

        acaoCliFor.add(tbCliFor, java.awt.BorderLayout.CENTER);
        ...
        acaoCliFor.add(divRight1, java.awt.BorderLayout.EAST);

        labelCliFor.setFont(new java.awt.Font("Segoe UI Light", 0, 10)); // NOI18N
        labelCliFor.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        labelCliFor.setText("Tipos de Pessoas");
        labelCliFor.setMaximumSize(new java.awt.Dimension(101, 21));
        labelCliFor.setMinimumSize(new java.awt.Dimension(101, 21));
        labelCliFor.setPreferredSize(new java.awt.Dimension(101, 21));
        acaoCliFor.add(labelCliFor, java.awt.BorderLayout.SOUTH);

        toolbar.add(acaoCliFor);
    ...
    private void btClienteMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btClienteMousePressed
        this.preparaCliente();
    }//GEN-LAST:event_btClienteMousePressed

    private void btFornecedorMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btFornecedorMousePressed
        this.preparaFornecedor();
    }//GEN-LAST:event_btFornecedorMousePressed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JPanel acaoCadastro;
    private javax.swing.JPanel acaoCliFor;
    private br.edu.materdei.tas.desktop.gui.core.TasItemToolBar btCliente;
    ...
    private br.edu.materdei.tas.desktop.gui.core.TasItemToolBar btFornecedor;
    ...
    private javax.swing.JLabel labelCliFor;
    ...
    private javax.swing.JPanel tbCliFor;
    ...
    private void preparaCliente() {
        this.showView = View.CLIENTE;
        
        //ToolBar
        btCliente.setSelected(true);
        btFornecedor.setSelected(false);
        ...
        labelAcaoMenu.setText("Ações de Cadastros Clientes");
        
        //Migalha
        migalha.setText("Cadastro de Cliente");
        
        //Tabela
        constroiTabelaCliVen();
    ...
    private void preparaFornecedor() {
        this.showView = View.FORNECEDOR;
        
        //ToolBar
        btCliente.setSelected(false);
        btFornecedor.setSelected(true);
        btIncluir.setToolTipText("Novo Fornecedor");
        btEditar.setToolTipText("Editar Fornecedor");
        btEditar.setEnabled(false);
        btExcluir.setToolTipText("Excluir Fornecedor");
        btExcluir.setEnabled(false);
        labelAcaoMenu.setText("Ações de Cadastros Fornecedores");
        
        //Migalha
        migalha.setText("Cadastro de Fornecedor");
        
        //Tabela
        constroiTabelaFornecedor();
        
        //Carrega Dados
        carregaGridFornecedor();
    }
    
    private void constroiTabelaCliVen() {
        //Monta tabela
        ...
        grid.getColumnModel().getColumn(1).setPreferredWidth(450);
        grid.getColumnModel().getColumn(2).setPreferredWidth(300);
        grid.getColumnModel().getColumn(3).setPreferredWidth(450);
        
        mainframe.setStatus("Pronto!");        
    }
    private void constroiTabelaFornecedor() {
        loadDados();
    ...
    public void loadDados() {
        ...
        try {
            ...
            try {
                switch (showView) {
                    case CLIENTE:
                        this.dados = BackendService.findAll("clientes");
                        break;
                        
                    case FORNECEDOR:
                        this.dados = BackendService.findAll("fornecedores");
                        break;
                }
    ...
    private void carregaGridCliente() {
        ...
        for (Object dado : this.dados) {
            JSONObject cliente = (JSONObject) dado;
            String cpf = format("###.###.###-##", cliente.getString("cpf"));
            modelo.addRow(new Object[] {cliente.get("codigo"), cliente.get("nome"), 
                                        cpf, cliente.get("email")});
        }
        grid.setModel(modelo);
        
        mainframe.setStatus("Pronto!");
    }
    private void carregaGridFornecedor() {
        DefaultTableModel modelo = (DefaultTableModel) grid.getModel();
        ...
        modelo.setNumRows(0);
        for (Object dado : this.dados) {
            JSONObject fornecedor = (JSONObject) dado;
            String cnpj = format("##.###.###/####-##", fornecedor.getString("cnpj"));
            modelo.addRow(new Object[] {fornecedor.get("codigo"), fornecedor.get("nome"), 
                                        cnpj, fornecedor.get("contato"), fornecedor.get("email")});
        }
        grid.setModel(modelo);
    ...
    private void showDialogCliente(JSONObject cliente) {
        ClienteDialog dialog = new ClienteDialog(mainframe, cliente);
        showDialog(dialog);
    ...
    private void showDialogFornecedor(JSONObject fornecedor) {
        FornecedorDialog dialog = new FornecedorDialog(mainframe, fornecedor);
        showDialog(dialog);
    ...
    private void editar() {
        ...
        switch (showView) {
            case CLIENTE:
                showDialogCliente(object);
                break;
            case FORNECEDOR:
                showDialogFornecedor(object);
                break;
        }
    }
        ...
        if (opcao == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                try {
                    ...
                    switch (showView) {
                        case CLIENTE:
                            BackendService.deleteById("clientes/"+ object.get("id"));
                            loadDados();
                            carregaGridCliente();
                            break;
                        case FORNECEDOR:
                            BackendService.deleteById("fornecedores/"+ object.get("id"));
                            loadDados();
                            carregaGridFornecedor();
                            break;
                    }
